...
public class LineageDAO extends AbstractMySQLOpenSourceDAO
{
	...
	private final static String DATA_WRAPPER = "select * from dict_dataset inner join (:sqlquery) as edges on (dict_dataset.id=edges.parent_id and edges.parent_type='data') or (dict_dataset.id=edges.child_id and edges.child_type='data');";

	private final static String DATA_EDGE_SELECTOR = "select * from family where parent_id in ((select distinct(parent_id) from family where child_id=(:id) and depth<(:depth)) and child_id in (select distinct(parent_id) from family where child_id=(:id) and depth<(:depth)) or ((select child_id from family where parent_id=(:id) and depth<(:depth)) and child_id in (select child_id from family where parent_id=(:id) and depth<(:depth)))) and depth=1;";
									   ...
									   List<LineageEdge> edges)
	{
		...
		resultNode.set("nodes", Json.parse("[{\"id\": 0,\"node_type\": \"data\",\"abstracted_path\": \"/DWH_TMP/DUMMY4\",\"storage_type\": \"SQLtest\",\"urn\": \"SQLtest:///DWH_TMP/DUMMY4\",\"job_type\": null,\"cluster\": null,\"project_name\": null,\"job_path\": null,\"job_name\": null,\"script_name\": null,\"script_path\": null,\"job_start_time\": null,\"job_end_time\": null,\"job_start_unix_time\": null,\"job_end_unix_time\": null,\"level\": 0,\"git_location\": null,\"_sort_list\": [\"abstracted_path\",\"urn\",\"storage_type\"],\"source_target_type\": null,\"exec_id\": null,\"job_id\": null,\"record_count\": null,\"application_id\": 0,\"format_mask\": null,\"partition_type\": null,\"operation\": null,\"partition_start\": null,\"partition_end\": null,\"full_object_name\": null,\"pre_jobs\": null,\"post_jobs\": null}," + 
			"{\"id\": 1,\"node_type\": \"job\",\"abstracted_path\": \"/DWH_TMP/DUMMY3\",\"job_type\": \"SQLtest\",\"urn\": \"SQLtest:///DWH_TMP/DUMMY3\",\"job_type\": null,\"cluster\": null,\"project_name\": null,\"job_path\": null,\"job_name\": \"alpha\",\"script_name\": null,\"script_path\": null,\"job_start_time\": null,\"job_end_time\": null,\"job_start_unix_time\": null,\"job_end_unix_time\": null,\"level\": 1,\"git_location\": null,\"_sort_list\": [\"abstracted_path\",\"storage_type\",\"urn\"],\"source_target_type\": null,\"exec_id\": null,\"job_id\": null,\"record_count\": null,\"application_id\": 0,\"format_mask\": null,\"partition_type\": null,\"operation\": null,\"partition_start\": null,\"partition_end\": null,\"full_object_name\": null,\"pre_jobs\": null,\"post_jobs\": null}]"));
		resultNode.set("links", Json.parse("[{\"id\": 0,\"source\": 0,\"target\": 1,\"label\": \"alpha\",\"chain\": \"\"}]"));
